...
v_for_vendetta = media.Movie('V for Vendetta',
                             "Following world war, London is a police state occupied by a fascist government, and a "
                             "vigilante known only as V (Hugo Weaving) uses terrorist tactics to fight the oppressors of the world in which he now lives.",
                             2005,
                             'James McTeigue',
...
hercules = media.Movie('Hercules',
                       "The son of the Greek Gods Zeus and Hera is stripped of his immortality as an infant and must"
                       "become a true hero in order to reclaim it.",
                       1995,
                       'Ron Clements and John Musker',
                       'https://31.media.tumblr.com/8fb4acba91d558615119d25c40789140/tumblr_inline_n571ften4m1rtf1yw.jpg',
...
garden_state = media.Movie('Garden State',
                           ...
                           2004,
                           'Zach Braff',
                           'http://www.masculinity-movies.com/wp-content/uploads/2012/04/600full-garden-state-poster.jpg',
                           'https://www.youtube.com/watch?v=u82n0e1mgmQ')

hunger_games = media.Movie('Hunger Games',
                           "Katniss Everdeen voluntarily takes her younger sister's place in the Hunger Games, a "
                           "televised fight to the death in which two teenagers from each of the twelve Districts of "
                           "Panem are chosen at random to compete.",
                           2012,
                           'Gary Ross',
...
movies = [toy_story, avatar, v_for_vendetta, school_of_rock, hercules, garden_state, hunger_games, lotr_1, lotr_2,
          lotr_3, matrix]
