...
lotr_1 = media.Movie('LOTR 1 - The Fellowship of the Ring', 'The story begins in the Shire, where the Hobbit Frodo Baggins inherits the Ring from Bilbo Baggins, his cousin and guardian.',
                     'http://www.movieposter.com/posters/archive/main/105/MPW-52979',
                     'https://www.youtube.com/watch?v=V75dMMIW2B4')

lotr_2 = media.Movie('LOTR 2 - The Two Towers', 'Orcs sent by Saruman and Sauron kill Boromir and kidnap Merry and Pippin. After agonizing over which pair of hobbits to follow, Aragorn, Gimli and Legolas pursue the orcs bearing Merry and Pippin to Saruman.',
                     'https://wtfbabe.files.wordpress.com/2012/11/two-towers-poster.jpg',
                     'https://www.youtube.com/watch?v=LbfMDwc4azU')

lotr_3 = media.Movie('LOTR 3 - The Return of the King', 'Sauron unleashes a heavy assault upon Gondor. Gandalf arrives at Minas Tirith to alert Denethor of the impending attack.',
...
import imdb
ia = imdb.IMDb()
ia.search_movie('The Matrix (1999)')
